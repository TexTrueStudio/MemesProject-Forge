...
package net.mcreator.memesproject.block;
...
import net.mcreator.memesproject.itemgroup.MemesProjectMaterialsItemGroup;
...
public class StoneGrainOreBlock extends MemesprojectModElements.ModElement {
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("stone_grain_ore", "stone_grain_ore", blockAt -> {
