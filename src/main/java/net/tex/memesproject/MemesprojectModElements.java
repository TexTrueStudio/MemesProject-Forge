...
public class MemesprojectModElements {
	...
	public MemesprojectModElements() {
		...
		sounds.put(new ResourceLocation("memesproject", "shooting_stars"),
				new net.minecraft.util.SoundEvent(new ResourceLocation("memesproject", "shooting_stars")));
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == MemesprojectModElements.ModElement.class)
						elements.add((MemesprojectModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(MemesprojectModElements.ModElement::initElements);
	}
