...
package net.tex.memesproject.block;
...
public class StoneGrainOreBlock extends MemesprojectModElements.ModElement {
	@ObjectHolder("memesproject:stone_grain_ore")
	public static final Block block = null;
	public StoneGrainOreBlock(MemesprojectModElements instance) {
		super(instance, 6);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_grain_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("memesproject:stone_grain_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("stone_grain_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("memesproject:stone_grain_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
